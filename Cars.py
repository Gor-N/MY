...
all_cars = ['Volvo', 'Volkswagen', 'Toyota', 'Tesla', 'Suzuki', 'Subaru','Bentley', 'Saturn', 'Saab', 'Rolls-Royce', \
            'Porsche', 'Nissan', 'Mitsubishi', 'Mini', 'Mercedes-Benz', 'Mazda', 'Lexus', 'Lincoln','Land Rover', 'Kia',\
            'Infiniti', 'Hyundai', 'Honda' , 'Genesis', 'Ford', 'BMW', 'Audi' , 'Acura']
...
for xxxx in all_cars :
    ...
    if xxxx in sweden_cars:
      if xxxx in sweden:
         print(xxxx + " is a Sweden car " + "made by " + " Zhejiang Geely Holding Group")
