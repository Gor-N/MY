all_cars = ['Volvo', 'Volkswagen', 'Toyota', 'Tesla', 'Suzuki', 'Subaru','Bentley', 'Saturn', 'Saab', 'Rolls-Royce', 'Porsche', 'Nissan', 'Mitsubishi', 'Mini', 'Mercedes-Benz', 'Mazda', 'Lexus', 'Lincoln','Land Rover', 'Kia', 'Infiniti', 'Hyundai', 'Honda' , 'Genesis', 'Ford', 'BMW', 'Audi' , 'Acura']
